...
Treat the task as L3/L4 until evidence narrows the risk. This authorizes the
smallest useful Codex subagent set; it does not authorize destructive,
irreversible, security-weakening, or public-contract-changing execution.
